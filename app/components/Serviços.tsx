  ...
  const data = [
    {
      id: "1",
      image:
        "https://ik.imagekit.io/x5s4extzn/REABILITA%C3%87%C3%83O%20DE%20CATIVOS.png?updatedAt=1690401968539",
    },
    {
      id: "2",
      image:
        "https://ik.imagekit.io/x5s4extzn/gnomoativado.png?updatedAt=1690401747144",
    },
    {
      id: "3",
      image:
        "https://ik.imagekit.io/x5s4extzn/Capturas.png?updatedAt=1690401967537",
    },
  ];

  return (
    <section id="serviços" className=" text-xl m-10 w-xl w-max-sm">
      ...
      <Swiper slidesPerView={1} pagination={{ clickable: true }} navigation>
        {data.map((item) => (
          <SwiperSlide key={item.id}>
            <img src={item.image} alt="slider" className="w-full h-22" />
          </SwiperSlide>
        ))}
      </Swiper>
      <div className="text-center text-xl">
        ...
        <p className="text-base font-montserrat p-3">
          {" "}
          Conectando a Manipulation-o-Matic ao BV6000, e com a ajuda das ondas
          lunares para intensificar as ondas cerebrais, é possível passar
          afirmações aos coelhos. As mais certeiras que utilizamos são:
        ...
        <p className="text-base font-montserrat p-3">
          ...
          movimentos suspeitos, as câmeras estão diretamente conectadas à sede
        ...
        <p className="text-base font-montserrat p-3">
          ...
          Competição Anual de Vegetais Gigantes de Tottington. Mas, como elas
          são realizadas?
        </p>
